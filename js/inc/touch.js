...
export default class Touch {
	...
	touchMove(e) {
        ...
        e.preventDefault();
        if (!this.hasMove){        
            if (this.numMove >= 2){ //undefined === this.clickDom || 
                this.hasMove = true;
            }else {
                this.numMove += 1;
            }
